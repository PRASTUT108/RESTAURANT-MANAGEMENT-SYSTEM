...
class RestaurantManagementSystem:
    ...
    def create_gui(self):
        ...
        for item, price in self.items.items():
            item_var = tk.IntVar()
            item_label = tk.Label(menu_frame, text=f"{item} - {self.convert_to_NRs(price)}")
    ...
    def show_bill_popup(self):
        ...
        for item, quantity in selected_items:
            bill += f"{item} x {quantity} - {self.convert_to_NRs(self.items[item] * quantity)}\n"
        bill += f"\nTotal Price: {self.convert_to_NRs(total_price)}\n"
    ...
    def update_sample_bill(self, item):
        ...
        for item, quantity in selected_items:
            bill += f"{item} x {quantity} - {self.convert_to_NRs(self.items[item] * quantity)}\n"
        bill += f"\nTotal Price: {self.convert_to_NRs(total_price)}\n"
        bill += f"Grand Total: {self.convert_to_NRs(total_price)}"
